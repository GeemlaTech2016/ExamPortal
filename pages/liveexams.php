...
if($user_role=="admin" || $user_role=="supervisor"){
    $query = "select * from exam where examtype='live'";
}
?>
<!DOCTYPE html>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- BEGIN THEME PANEL -->
                        <h3 class="page-title">
                        Manage Test Takers <small>View and Manage Live Exams</small>
                        </h3>
                        <!-- END THEME PANEL -->
                        <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
					    ...
					    <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box purple">
                                <div class="portlet-title">
                                    <div class="caption">
                                            <i class="fa fa-globe"></i>Live Exam List </div>
                                        <div class="tools"> </div>
                                </div>
