...
if($user_role=="admin" || $user_role=="supervisor"){
    $query = "select * from feedbacks order by datet desc";
}
?>
<!DOCTYPE html>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $app_name; ?> | All Feedbacks</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- BEGIN THEME PANEL -->
                        <h3 class="page-title">
                        Feedbacks from Candidates <small>&nbsp;</small>
                        </h3>
                        <!-- END THEME PANEL -->
                        <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
					    ...
					    <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box purple">
                                <div class="portlet-title">
                                    <div class="caption">
                                            <i class="fa fa-globe"></i>All Feedbacks </div>
                                        <div class="tools"> </div>
                                </div>
