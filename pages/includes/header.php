<?php
$quser = mysqli_query($conn,"select * from login where username = '$uid'");
$getuser = mysqli_fetch_array($quser);
$fname = $getuser['fname'];
?>
<div class="page-header navbar navbar-fixed-top">
        ...
        function ()
        {
        $('#end_me').load('api/end_exam.php').fadeIn("slow");
        }, 30000); // autorefresh the content of the div after
                   //every 30000 milliseconds(30sec)
        </script>
        <span id="end_me" style="display: hidden;"></span>