...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $app_name; ?> | Add Question</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                        ...
                        <?php
                            ...
                            if(array_key_exists("save",$_POST)){
                                if($questtype=='1'){ //start qtype 1
                                    ...
                                    $q = mysqli_query($conn, "insert into questions(questionid,question,casestudy,optiona,optionb,optionc,optiond,
                                                optione,ans,testseries,questionmarks,hint,qtype)
                                            values('$qid','$question','$casestudy','$optiona','$optionb','$optionc','$optiond','$optione',
                                            '$ans','$testseries','$questionmarks','$hint','$questtype')") or die(mysqli_error($conn));
                                    if($q){
                                    ...
                                    $q = mysqli_query($conn, "insert into questions(questionid,question,casestudy,optiona,optionb,optionc,optiond,
                                                optione,ans,testseries,questionmarks,hint,qtype)
                                            values('$qid','$question','$casestudy','$optiona','$optionb','$optionc','$optiond','$optione',
                                            '$fans','$testseries','$questionmarks','$hint','$questtype')") or die(mysqli_error($conn));
                                    if($q){
                                        header("location:addtestseries.php?examid='".$examid."'&testseries='".$testseries."'");
                                    }else{
                                        ?>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-comments"></i>Add Question for <?php echo $gettest['testseries']?>
							</div>
							<div class="tools">
                        ...
                        <form role="form" method="post" action="">
                                    <table class="table table-striped table-hover">
                                        <tr valign="top">
                                            ...
                                            <td > <textarea name="question" id="summernote_1">	</textarea>
                                        ...
                                        <tr>
                                            ...
                                            <div class="margin-top-10">
                                                <button type="submit" name="save" class="btn green">Add Question </button>
