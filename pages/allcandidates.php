...
if($user_role=="admin" || $user_role=="supervisor"){
    $query = "select * from login where userrole='testtaker'";
}
?>
<!DOCTYPE html>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $app_name; ?> | All Test Takers</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- BEGIN THEME PANEL -->
                        <h3 class="page-title">
                        Manage Test Takers <small>View and Manage Test takers</small>
                        </h3>
                        <!-- END THEME PANEL -->
                        <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
					    ...
					    <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box purple">
                                <div class="portlet-title">
                                    <div class="caption">
                                            <i class="fa fa-globe"></i>Test Takers List </div>
                                        <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-scrollable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $pvs['regdate']?>
                                            </td>
                                            <td>
                                            <?php echo $pvs['sname']." ".$pvs['fname']?>
                                            </td>
                                            <td>
                                            <?php echo $pvs['gender']?>
                                            </td>
                                            <td>
                                            <?php echo $pvs['username'] ?>
                                            </td>
                                            <td>
                                            <?php echo $pvs['mobile'] ?>
                                            </td>
                                            <td>
                                            <a href="allcandidates.php?pv=<?php echo $pvs['username']?>"><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                                }
